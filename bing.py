...
def bing_rewards(q_str,bingCK,isPc):	
  try:
    ...
    if isPc == 1:
    	...
    	ua = "Mozilla/5.0 (Linux; Android 12; JEF-AN00) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Mobile Safari/537.36 EdgA/114.0.1823.74"
